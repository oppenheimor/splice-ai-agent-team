...
The keys live in `.codex/settings.json` (project) or `/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/settings.json` (global) — **not** in `.planning/config.json`:
