...
<required_reading>
@/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/get-shit-done/references/ai-frameworks.md
@/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/agents/gsd-eval-planner.md for instructions.
