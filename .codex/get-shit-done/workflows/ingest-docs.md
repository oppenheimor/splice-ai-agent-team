...
```bash
INIT=$(node "/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/get-shit-done/bin/gsd-tools.cjs" commit \
