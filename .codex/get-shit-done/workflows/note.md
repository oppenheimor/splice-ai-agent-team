...
- **Global scope**: `/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/notes/`)
...
2. Glob `/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/notes/` — works in any directory
