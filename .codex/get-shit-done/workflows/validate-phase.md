...
```
Agent(
  prompt="Read /Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/paulchess/Desktop/Home/entrepreneurship/splice-ai-agent-team/.codex/get-shit-done/templates/VALIDATION.md`
